...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "iservices@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "iservices API";

        private String description = "iservices API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "iservices";
